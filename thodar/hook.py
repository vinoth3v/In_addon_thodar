...
def thodar_form_alter(form, post, entity = None):
	...
	if thodar:
		...
		options = OrderedDict()
		options['new'] = s('This is a new {thodar}', {'thodar' : s_thodar_name})
		options['thodar'] = s('Add this as a continuity to another content')
		options['sub'] = s('Add this as a sub of another content')
